...
define( 'NABER_CHAT_VERSION', '1.26.0' );
...
require_once NABER_CHAT_DIR . 'includes/class-naber-stickers.php';
...
require_once NABER_CHAT_DIR . 'includes/class-naber-blocks.php';
require_once NABER_CHAT_DIR . 'includes/class-naber-polls.php';
